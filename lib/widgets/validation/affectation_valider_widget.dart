...
class AffectationsValiderListWidget extends StatelessWidget {
  const AffectationsValiderListWidget({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(builder: (context) {
      ...
      } else if (affectationProvider.affectationsValider.isEmpty) {
          ...
          Expanded(
            child: Builder(builder: (context) {
              return ListView.builder(
                itemCount: affectationProvider.affectationsValider.length,
                              ...
                              builder: (context) {
                                return ClientInfoModalWidget(
                                  ...
                                  affectation: affectationProvider
                                      .affectationsValider[i],
                                );
                              });
                        },
                        affectation: affectationProvider.affectationsValider[i],
                        showInfoIcon: true),
                  );
                },
              );
