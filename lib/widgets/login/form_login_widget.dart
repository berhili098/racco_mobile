          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Column(
                  children: [
                    Image.asset("assets/imgs/login/logo.png",height: 250.r,),
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Visibility(
                              visible:
                                  userProvider.errorEmailTxtField.isNotEmpty,
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            TextFieldFormsEditProfileWidget(
                              validator: (value) {
                                userProvider.checkErrorPassword(
                                    userProvider.password(value, context));
                              ...
                              suffixIcon: InkWell(
                                  onTap: () => {userProvider.showPassword()},
                            ...
                            Visibility(
                              visible:
                                  userProvider.errorPasswordTxtField.isNotEmpty,
                              child: Padding(
                                padding: const EdgeInsets.all(8.0),
                                child: Text(
