...
class PromoteurListWidget extends StatefulWidget {
  const PromoteurListWidget({Key? key}) : super(key: key);

  @override
  State<PromoteurListWidget> createState() => _PromoteurListWidgetState();
}

class _PromoteurListWidgetState extends State<PromoteurListWidget> {
  @override
            ...
            Expanded(
              child: Builder(builder: (context) {
                return SmartRefresher(
                  ...
                  onRefresh: () => affectationProvider.onRefreshPromoteur(context,userProvider.userData!.technicienId.toString()),
                  onLoading: () => clientProvider.onLoading(context,userProvider.userData!.technicienId.toString()),
                  child: ListView.builder(
                    itemCount: affectationProvider.affectationsPromoteur.length,
                              ...
                              showModalBottomSheet(
                                  ...
                                  builder: (context) {
                                    return ClientInfoModalWidget(
                                      ...
                                      affectation: affectationProvider.affectationsPromoteur[i],
                                    );
                                  }).whenComplete((){});
                            },
                            affectation: affectationProvider.affectationsPromoteur[i],
