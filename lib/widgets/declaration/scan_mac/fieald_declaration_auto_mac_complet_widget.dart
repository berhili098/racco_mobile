...
class FiealdDeclarationAutoCompletMacWidget extends StatefulWidget {
  ...
  const FiealdDeclarationAutoCompletMacWidget(
      {super.key,
      this.title,
      this.prefixText,
      this.onTap,
  ...
  @override
  State<FiealdDeclarationAutoCompletMacWidget> createState() =>
      _FiealdDeclarationAutoCompletMacWidgetState();
}

class _FiealdDeclarationAutoCompletMacWidgetState
    extends State<FiealdDeclarationAutoCompletMacWidget> {
  @override
  Widget build(BuildContext context) {
    String currentText = "";
    final declarationProvider = Provider.of<DeclarationProvider>(context);
    GlobalKey<AutoCompleteTextFieldState<String>> keyGpon = GlobalKey();
    ...
    return Column(
      ...
      children: [
          ...
          children: [
            Expanded(
              child: SimpleAutoCompleteTextField(
                  ...
                  clearOnSubmit: false,
                  textSubmitted: (text) {
                    declarationProvider.setRouteturMacController(text);
            ...
            InkWell(
              onTap: () {
                showModalBottomSheet(
                    ...
                    context: context,
                    builder: (context) {
                      return const ScanBarCodeMacPage();
                    }).whenComplete(() {});
              },
              child: Container(
        ...
        Visibility(
          visible: declarationProvider.checkMacValidationText.isNotEmpty,
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text(
              declarationProvider.checkMacValidationText,
              style: TextStyle(
                  fontSize: 14.sp,
                  fontWeight: FontWeight.w400,
                  color: Colors.red),
