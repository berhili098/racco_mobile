...
class ScanBarCodeMacPage extends StatefulWidget {
  const ScanBarCodeMacPage({Key? key}) : super(key: key);
...
class _BarcodeScannerWithScanWindowState
    extends State<ScanBarCodeMacPage> {
            ...
            children: [
              ...
              if (_isFirstDetection) {
                ...
                for (final barcode in barcodes) {
                  ...
                  declarationProvider
                      .getValueMacFromScan(barcode.rawValue ?? '');
                }
              }
            },
              ),
                    ...
                    children: [
                      ...
                      Center(
                        child: SizedBox(
                          ...
                          child: FittedBox(
                            child: Text(
                              barcode?.displayValue ?? 'Scanner le code bare ( MAC )',
