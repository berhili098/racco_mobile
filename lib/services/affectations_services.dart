...
class AffectationsApi {
  ...
  Future getAffectationPromoteurTechnicien(String id) async {
    var headers = {'Accept': 'application/json'};
    // init the url
    Uri uri = Uri.http(apiUrl, '/~newera22/app/public/api/getAffectationPromoteurApi/$id');
  ...
  Future getAffectationPlanifier(String id) async {
    var headers = {'Accept': 'application/json'};
    // init the url
    Uri uri = Uri.http(apiUrl, '/~newera22/app/public/api/getAffectationPlanifier/$id');
  ...
  Future getAffectationValider(String id) async {
    var headers = {'Accept': 'application/json'};
    // init the url
    Uri uri = Uri.http(apiUrl, '/~newera22/app/public/api/getAffectationValider/$id');
  ...
  Future getAffectationDeclarer(String id) async {
    var headers = {'Accept': 'application/json'};
    // init the url
    Uri uri = Uri.http(apiUrl, '/~newera22/app/public/api/getAffectationDeclarer/$id');
  ...
  Future getAffectationBlocage(String id) async {
    var headers = {'Accept': 'application/json'};
    // init the url
    Uri uri = Uri.http(apiUrl, '/~newera22/app/public/api/getAffectationBlocage/$id');
   ...
   Future getAffectationBlocageBeforeValidation(String id) async {
    var headers = {'Accept': 'application/json'};
    // init the url
    Uri uri = Uri.http(apiUrl, '/~newera22/app/public/api/getAffectationBlocageAfterDeclared/$id');
  ...
  static Future addImageAffectation(String id, String path) async {
    var headers = {'Accept': 'application/json'};
    Uri uri = Uri.http('127.0.0.1:8000', '/~newera22/app/public/api/storeImageAffectation');
    return http.post(uri,
        headers: headers, body: {'affectations_id': "121", 'img_path': path});
  }

  Future planifierAffectation(String id, String datePlanification,String technicienId) async {
    var headers = {'Accept': 'application/json'};
    Uri uri = Uri.http(apiUrl, '/~newera22/app/public/api/planifierAffectation');
    return http.post(uri,
        headers: headers,
        body: {'id': id, 'planification_date': datePlanification,'technicien_id':technicienId});
  }

  Future declarerAffectation(Object data) async {
    var headers = {'Accept': 'application/json'};
    Uri uri = Uri.http(apiUrl, '/~newera22/app/public/api/declarationAffectation');
  ...
  Future validationAffectation(Object data) async {
    var headers = {'Accept': 'application/json'};
    Uri uri = Uri.http(apiUrl, '/~newera22/app/public/api/validationAffectation');
    return http.post(uri, headers: headers, body: data);
  }
}
